# ==============================================================================
# R ggplot2 Theme & Scale Bridge: Cell
# Publisher: Cell Press (Elsevier)
# Guidelines: https://www.cell.com/cell/authors
# Last Verified: 2026-09-11
# ==============================================================================
# Sizing Reference:
#   Single column width: 85.0 mm
#   Double column width: 174.0 mm
...
#' Cell Compliant Color-Blind Safe Palette (Okabe-Ito)
#' @export
palette_cell <- c(
  "blue" = "#0072B2",
  "vermilion" = "#D55E00",
...
#' Discrete Color Scale for Cell
#' @param ... Arguments passed to ggplot2::scale_color_manual
#' @export
scale_color_cell <- function(...) {
  ggplot2::scale_color_manual(values = palette_cell, ...)
}

#' @rdname scale_color_cell
#' @export
scale_colour_cell <- scale_color_cell

#' Discrete Fill Scale for Cell
#' @param ... Arguments passed to ggplot2::scale_fill_manual
#' @export
scale_fill_cell <- function(...) {
  ggplot2::scale_fill_manual(values = palette_cell, ...)
}
