# ==============================================================================
# R ggplot2 Theme & Scale Bridge: Nature
# Publisher: Nature Portfolio (Springer Nature)
# Guidelines: https://www.nature.com/nature/for-authors/final-submission
# Last Verified: 2026-09-11
# ==============================================================================
# Sizing Reference:
#   Single column width: 89.0 mm
#   Double column width: 180.0 mm
...
#' Nature Compliant Color-Blind Safe Palette (Okabe-Ito)
#' @export
palette_nature <- c(
  "blue" = "#0072B2",
  "vermilion" = "#D55E00",
...
#' Nature Publication Theme for ggplot2
#'
#' @param base_size Base font size in points (default: 6.0 pt)
#' @param base_family Base font family (default: "Arial")
#' @return A ggplot2 theme object
#' @export
theme_nature <- function(base_size = 6.0, base_family = "Arial") {
...
#' @export
ggsave_nature <- function(filename,
