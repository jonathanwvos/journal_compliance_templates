# ==============================================================================
# R ggplot2 Theme & Scale Bridge: Journal of Clinical Oncology
# Publisher: American Society of Clinical Oncology (ASCO)
# Guidelines: https://ascopubs.org/journal/jco/author-instructions
# Last Verified: 2026-09-15
# ==============================================================================
# Sizing Reference:
#   Single column width: 84.6 mm
#   Double column width: 169.4 mm
#   Max figure height:   225.0 mm
#   Line art DPI:        1000
# ==============================================================================
...
#' Journal of Clinical Oncology Compliant Color-Blind Safe Palette (Okabe-Ito)
#' @export
palette_jco <- c(
  "blue" = "#0072B2",
  "vermilion" = "#D55E00",
...
#' Journal of Clinical Oncology Publication Theme for ggplot2
#'
#' @param base_size Base font size in points (default: 7.0 pt)
#' @param base_family Base font family (default: "Arial")
#' @return A ggplot2 theme object
#' @export
theme_jco <- function(base_size = 7.0, base_family = "Arial") {
...
#' Discrete Color Scale for Journal of Clinical Oncology
#' @param ... Arguments passed to ggplot2::scale_color_manual
#' @export
scale_color_jco <- function(...) {
  ggplot2::scale_color_manual(values = palette_jco, ...)
}

#' @rdname scale_color_jco
#' @export
scale_colour_jco <- scale_color_jco

#' Discrete Fill Scale for Journal of Clinical Oncology
#' @param ... Arguments passed to ggplot2::scale_fill_manual
#' @export
scale_fill_jco <- function(...) {
  ggplot2::scale_fill_manual(values = palette_jco, ...)
}
...
ggsave_jco <- function(filename,
  ...
  if (is.null(height_mm)) {
    height_mm <- min(225.0, width_mm * 0.75)
  } else {
    height_mm <- min(225.0, height_mm)
  }
